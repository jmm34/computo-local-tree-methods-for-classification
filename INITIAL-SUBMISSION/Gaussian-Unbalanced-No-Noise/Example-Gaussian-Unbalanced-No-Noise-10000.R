...
sink("Example-Gaussian-Unbalanced-No-Noise-Output-10000.txt")
...
write.table(cbind(resBayes,resBagging,resRF,resLVIRF,resCsrf5,resCsrf10,resCsrf50,resCsrf150,resCsrf250,resCsrf350,resDVSRF1,resDVSRF2,resKVRF1,resKVRF2,resKVRF3,resKVRF4,resNNRF1,resNNRF2,resNNRF3),file="Example-Gaussian-Unbalanced-No-Noise-Res-10000.txt",quote=FALSE,row.names=FALSE)
